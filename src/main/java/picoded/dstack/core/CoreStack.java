...
public abstract class CoreStack {
	...
	public Core_DataObjectMap dataObjectMap(String name) {
		return (Core_DataObjectMap)cacheDataStructure(name, "DataObjectMap", Core_DataObjectMap.class);
	}
	...
	public Core_FileWorkspaceMap fileWorkspaceMap(String name) {
		return (Core_FileWorkspaceMap)cacheDataStructure(name, "FileWorkspaceMap", Core_FileWorkspaceMap.class);
	}
	...
	public Core_DataStructure cacheDataStructure(String name, String type, Class cObj) {
		...
		if( cache != null ) {
			...
			throw new RuntimeException("Invalid data structure type found in cache for: "+name+" / "+cObj.getSimpleName());
		}
